...
CREATE TABLE `tests` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKtb6yw9lwfpu3lem5xd701eosr` (`subjects_id`),
  CONSTRAINT `FKtb6yw9lwfpu3lem5xd701eosr` FOREIGN KEY (`subjects_id`) REFERENCES `subjects` (`id`)
...
-- Dump completed on 2020-08-04 14:18:24
